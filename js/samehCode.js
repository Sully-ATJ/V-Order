...
//-------------------------------------------------//
// This function is added by sameh // 
...
var shoppingCart = (function() {
  ...
  $('.add-to-cart').click(function(event) {
	...
	speak(name,price,1); // added by sameh ----------------------------//  
    displayCart();
  });
